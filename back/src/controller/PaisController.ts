...
class PaisController {
    async create(req: Request, res: Response) {
        try {
            ...
            new_pais.cd_bairro_pk = cd_bairro_pk;
            new_pais.nm_bairro = nm_bairro;
            new_pais.cd_user_alteracao = cd_user_alteracao;
            new_pais.cd_user_inclusao = cd_user_inclusao;
            new_pais.fl_bairro_ativo = fl_bairro_ativo;
            new_pais.cd_municipio_fk = cd_municipio_fk;

            await BairroRepo.save(new_pais);
    ...
    async findById(req: Request, res: Response) {
        ...
        try {
            let cd_bairro_pk = parseInt(req.params["cd_bairro_pk"])
            const new_pais = await BairroRepo.getById(cd_bairro_pk)
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            new_pais.cd_bairro_pk = cd_bairro_pk;
            new_pais.nm_bairro = req.body.nm_bairro;
            new_pais.cd_user_alteracao = req.body.cd_user_alteracao;
            new_pais.cd_user_inclusao = req.body.cd_user_inclusao;
            new_pais.fl_bairro_ativo = req.body.fl_bairro_ativo;
            new_pais.cd_municipio_fk = req.body.cd_municipio_fk;

            await BairroRepo.update(new_pais);
